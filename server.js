...
// 4. Create Opay payment link for auto-fill
app.post("/create-opay-link", async (req, res) => {
  try {
    ...
    const payload = {
      ...
      callbackUrl: process.env.OPAY_CALLBACK_URL || "https://your-domain.com/payment-callback",
      returnUrl: process.env.OPAY_RETURN_URL || "https://your-domain.com/payment-success",
      userInfo: {
        userId: userId
      },
      product: {
        name: "VoicePay Transfer",
